      ...
      <Card shadow="lg" isPressable onPress={handleCardPress}>
        <CardBody className="overflow-visible p-0">
          ...
          <div className="absolute top-2 right-2 z-50">
            ...
            >
              {/* Icono SVG para añadir al carrito */}
              <svg
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M12 3.75a.75.75 0 0 1 .75.75v6.75h6.75a.75.75 0 0 1 0 1.5h-6.75v6.75a.75.75 0 0 1-1.5 0v-6.75H4.5a.75.75 a 0 0 1 0-1.5h6.75V4.5a.75.75 a 0 0 1 .75-.75Z"
                  clipRule="evenodd"
                />
              </svg>
            </Button>
